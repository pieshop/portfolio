...
export default class Dropdown extends Component {
        ...
        return (
            <div class={'dropdown year_drop text-center ' + dropClass}>
                <button class="btn btn-sm btn-info dropdown-toggle"
                        type="button" id="dropdownMenuYear"
                ...
                <div class={'dropdown-menu ' + dropClass} aria-labelledby="dropdownMenuYear">
                    <Link to={'/' + category_id + '/' + constants.ALL_YEARS}
                          class="dropdown-item date_link"
                          data-year={constants.ALL_YEARS}
                          onClick={this.handleDropDownLinkClick}>All Years</Link>
    ...
    renderItem(data) {
        return <DropdownLink
            key={data.year}
            linkClick={this.handleDropDownLinkClick}
            {...data}
        />;
    }
