...
export default class ItemDetails extends Component {
    render() {
        const {client_label, technologies, territories, has_frameworks, frameworks, platforms} = this.props;
                    ...
                    <ul class="list-group list-group-flush">
                        ...
                        <li class="list-group-item flex-column align-items-start">
                            <div class="d-flex w-100 justify-content-between">
                                ...
                                <span class="flex-row">
                                    {frameworks.map(this.renderFramework)}
                                </span>
                            </div>
                        </li>
                        }
    ...
    renderFramework = (data) => {
        ...
        if (data.url) {
            fragment = <a class="p-1" key={data.name} href={data.url} target="_blank">{data.name}</a>;
        }
        return fragment;
    }
}
