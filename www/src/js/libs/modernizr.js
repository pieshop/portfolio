/*!
 * modernizr v3.3.1
 * Build http://modernizr.com/download?-canvas-cookies-cors-fileinput-filereader-filesystem-flash-flexbox-flexwrap-imgcrossorigin-localstorage-placeholder-requestanimationframe-touchevents-addtest-atrule-domprefixes-hasevent-mq-prefixed-prefixedcss-prefixedcssvalue-prefixes-setclasses-testallprops-testprop-teststyles-dontmin
 *
 * Copyright (c)
 *  Faruk Ates
 *  Paul Irish
...
(function(window, document, undefined) {
  ...
  var mq = (function() {
    ...
    return function(mq) {
      ...
      injectElementWithStyles('@media ' + mq + ' { #modernizr { position: absolute; } }', function(
        node
      ) {
        bool =
